...
@stop<div class="row">
	<div class="large-12">
        ...
        <div class="price-field">
                ...
                {{ Form::text('price',$product->price, array('required' =>'required', 'placeholder'=> Lang::get('products.product--price'), 'pattern' => 'number')) }}
                <small class="error">{{Lang::get('products.error--number')}}</small>
            </div>
        <div class="description-field">
                {{ Form::label('description', Lang::get('products.product--description').':') }}
                {{ Form::textarea('description',$product->description, array('required' =>'required', 'placeholder'=> Lang::get('products.product--description'))) }}
