...
@stop<div class="row">
	<div class="large-12">
		...
		<div class="name-field">
                ...
                {{ Form::text('name',$store->name, array('required' =>'required', 'placeholder'=> Lang::get('stores.store--name'))) }}
                <small class="error">{{Lang::get('stores.error--nametaken')}}</small>
        </div>
        <div class="description-field">
                {{ Form::label('description', Lang::get('stores.store--description').':') }}
                {{ Form::textarea('description',$store->description, array('required' =>'required', 'placeholder'=> Lang::get('stores.store--description'))) }}
